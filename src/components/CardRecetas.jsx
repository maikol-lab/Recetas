...
const CardRecetas = ({ item }) => {
    ...
    // Función para calcular precio basado en dificultad y tiempo
    ...
    return (
        <>
            ...
            {/* Modal integrado directamente - SIN COMPONENTE SEPARADO */}
            <div className="modal fade" id={`modalReceta-${item.id}`} tabIndex="-1" aria-hidden="true">
                            ...
                            <div className="d-flex align-items-center w-100">
                                <div className="flex-grow-1">
                                    ...
                                    <small className="text-white-50">
                                        ...
                                        Precio: ${calcularPrecioReceta(item).toFixed(2)}
                                    </small>
                                </div>
                                <button
                                    type="button"
...
// Función auxiliar para clases de badge de dificultad
